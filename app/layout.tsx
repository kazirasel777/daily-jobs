...
export const metadata: Metadata = {
  ...
  // ✅ ফেভিকন সঠিকভাবে কাজ করানোর জন্য নিচের icons অংশটি যুক্ত করা হলো
  icons: {
    icon: '/favicon.ico?v=1', // ভার্সন প্যারামিটার যুক্ত করা হয়েছে যাতে ব্রাউজার নতুন আইকন লোড করে
  },
  openGraph: {
    title: "দৈনিক চাকরি | আপনার স্বপ্নের চাকরি খুঁজুন",
